...
import JsonBig from './json-big.js'
import { snakizeKeys, pascalizeKeys, mapObject, filterObject } from './other.js'
import { snakeToPascal } from './string.js'
 ...
 */
async function genSwaggerClient(
  specUrl,
